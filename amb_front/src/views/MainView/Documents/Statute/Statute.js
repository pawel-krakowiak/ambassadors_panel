...
import stylesLight from './Statute.module.scss'
import stylesDark from './StatuteDark.module.scss'
...
const Statute = () => {
    ...
    return(
        <div className={styles.wrapper}>
            <div className={styles.title}><p className="bigTxt">Regulamin użytkownika</p></div>
            ...
            <FaqItem id={1} title={'Pierwszy paragraf'} content={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex'} />
                ...
                <FaqItem id={5} title={'Piąty paragraf'} content={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex'} />
            </div>
        </div>
    )
}
